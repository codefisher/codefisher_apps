...
urlpatterns = patterns('',
    ...
    url(r'^request/follow/(?P<request_id>\d+)/$', views.IconRequestFollow.as_view(), name='pastel-svg-request-follow'),
    ...
    url(r'^request/vote/(?P<request_id>\d+)/$', views.IconRequestVote.as_view(), name='pastel-svg-request-vote'),
    url(r'^request/vote/(?P<request_id>\d+)/ajax/$', views.IconRequestVoteAjax.as_view(), name='pastel-svg-request-vote-ajax'),
